...
class MVidVRD(imdb):
    def __init__(self, image_set,  devkit_path=None):
        imdb.__init__(self, 'MVidVRD_'+ image_set)
        self._year = '2012'
        self._image_set = image_set
        self._devkit_path = cfg_d.MVidVRD#self._get_default_path() if devkit_path is None \
            #else devkit_path
        self._data_path = os.path.join(self._devkit_path)
        self._classes = ('__background__',  # always index 0
                         'airplane','ball','bear','bicycle','bus','car','cat','dog','elephant','horse','motorcycle','person','skateboard','sofa','train')
